...
<?php if($project && $currantWorkspace && $task): ?>
    ...
    <form class="pl-3 pr-3" method="post" action="<?php echo e(route('tasks.update',[$currantWorkspace->slug,$project->id,$task->id])); ?>">
        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /Users/macbook/Desktop/projects/taskly/resources/views/projects/taskEdit.blade.php ENDPATH**/ ?>